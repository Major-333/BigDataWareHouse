...
load data infile '/dw_data/mysqlData/emotion_score_schema'
...
load data infile '/dw_data/mysqlData/score_schema'
    into table score
    fields terminated by ','
    lines terminated by '\n'
    ignore 1 lines
...
load data infile '/dw_data/mysqlData/day_schema'
...
load data infile '/dw_data/mysqlData/user_schema'
...
load data infile '/dw_data/mysqlData/movie_schema'
    ignore into table movie
    fields terminated by ','
    OPTIONALLY ENCLOSED BY '"'
    lines terminated by '\n'
    ignore 1 lines
    (product_id, @score_score, @emotion_score_emotion_score, @time_time_id,@title,@version)
    set
...
load data infile '/dw_data/mysqlData/actor_schema'
...
load data infile '/dw_data/mysqlData/director_schema'
...
load data infile '/dw_data/mysqlData/label_schema'
...
load data infile '/dw_data/mysqlData/review_schema'
